...
import {inputCheck, mainFunction, getIncompleteTasks, sortArray, filteredArrayList, completeButtonToggle} from "./miscFunctions";
...
$('#save-button').on('click', () => {
  ...
  let newIdeaObject = new NewTodo(...val);
